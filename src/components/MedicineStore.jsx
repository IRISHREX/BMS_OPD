...
const MedicineStore = () => {
  ...
  return (
    <section className="page bg-light-blue medicine-store-page">
        ...
        <Toolbar>
          <div className="medicine-store-header">
            ...
            <div className="search-bar-container">
              <form onSubmit={handleSearch} className="search-form medicine-search-form">
                ...
                <button type="submit" className="medcine-nav-icon-btn"
                // className="btn btn-search"
                >
                  <FiSearch title="Search" />
                  {/* Search */}
                </button>
                <button className="medcine-nav-icon-btn"
                  type="button"
        ...
        <div className="medicines-container">
          {loading ? (
            ...
            <div className="empty-state">
              ...
              <p>
                Try adjusting your search or add a new medicine to get started
              </p>
