...
const InvoiceSettings = () => {
  ...
  const modalStyle = {
    background: '#fff', padding: 16, borderRadius: 8, width: '90%', maxWidth: 900, maxHeight: '80vh', overflowY: 'auto'
  };
          ...
          <div style={{ display:'grid'}}>
            ...
            <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginTop:8 }}>
              ...
              <div style={{ display:'flex', gap:8 }}>
                ...
                {editing && <button className="btn btn-ghost" onClick={()=>{ setEditing(null); setForm({ invoiceNumber: '', patient: '', appointment: '', doctor:'', items: [], tax:0, discount:0, dueDate: '', status: 'Unpaid', notes: '' }); }}>Cancel</button>}
              </div>
            </div>
          </div>
        </div>
